...
const voyages = [
    ...
    // Early Sidewheeler Steamboats (1818-1850)
    { id: 251, year: 1818, vessel: "Walk-in-the-Water", from: "Buffalo", to: "Detroit", type: "passenger", cargo: "29 passengers (maiden voyage)", captain: "Lake Erie Steamboat Co.", tonnage: 330, distance: 260, duration: "44 hours", source: "https://greatlakesecho.org/2019/10/21/the-first-great-lakes-steamboat-was-a-walk-in-the-water/" },
    { id: 252, year: 1819, vessel: "Walk-in-the-Water", from: "Detroit", to: "Mackinac Island", type: "passenger", cargo: "passengers", captain: "Lake Erie Steamboat Co.", tonnage: 330, distance: 280, duration: "3 days", source: "https://en.wikipedia.org/wiki/Walk-in-the-Water_(steamboat)" },
    { id: 253, year: 1819, vessel: "Walk-in-the-Water", from: "Mackinac Island", to: "Green Bay", type: "passenger", cargo: "passengers (first on Lake Michigan)", captain: "Lake Erie Steamboat Co.", tonnage: 330, distance: 90, duration: "18 hours", source: "https://gratefulamericanfoundation.org/what-was-the-name-of-the-first-steamboat-to-sail-the-great-lakes/" },
    { id: 254, year: 1822, vessel: "Superior (sidewheeler)", from: "Buffalo", to: "Detroit", type: "passenger", cargo: "passengers", captain: "Lake Erie Steamboat Co.", tonnage: 354, distance: 260, duration: "40 hours", source: "https://navalmarinearchive.com/research/docs/early_gl_steamboats.html" },
    { id: 255, year: 1825, vessel: "Pioneer (sidewheeler)", from: "Cleveland", to: "Detroit", type: "passenger", cargo: "passengers & cargo", captain: "Early steamboat service", tonnage: 280, distance: 95, duration: "16 hours", source: "https://tripsintohistory.com/2013/02/09/the-palace-steamers-of-the-great-lakes/" },

    // Canal Boats & "Canallers" (1829-1900)
    { id: 256, year: 1829, vessel: "Annie and Jane (schooner)", from: "York", to: "Chippawa", type: "canal boat", cargo: "general freight", captain: "Welland Canal trial run", tonnage: 85, distance: 27, duration: "8 hours", source: "https://www.thecanadianencyclopedia.ca/en/article/welland-canal-feature" },
    { id: 257, year: 1829, vessel: "R.H. Boughton", from: "Youngstown", to: "Chippawa", type: "canal boat", cargo: "freight", captain: "Welland Canal trial run", tonnage: 82, distance: 27, duration: "8 hours", source: "https://en.wikipedia.org/wiki/Welland_Canal" },
    { id: 258, year: 1845, vessel: "Canaller (150-ft locks)", from: "Buffalo", to: "Chicago", type: "canal boat", cargo: "grain (800 tons)", captain: "Second Welland era", tonnage: 850, distance: 650, duration: "6 days", source: "https://www.maritimehistoryofthegreatlakes.ca/documents/hgl/default.asp?ID=c023" },
    { id: 259, year: 1870, vessel: "Erie Canal Packet Boat", from: "Buffalo", to: "Albany", type: "canal passenger", cargo: "immigrants westbound", captain: "Horse-drawn canal packet", tonnage: 45, distance: 360, duration: "5 days", source: "https://www.eriecanal.org/boats.html" },
    { id: 260, year: 1880, vessel: "Canaller (box-like hull)", from: "Cleveland", to: "Buffalo", type: "canal freight", cargo: "lumber", captain: "Welland Canal service", tonnage: 920, distance: 180, duration: "2.5 days", source: "https://navalmarinearchive.com/research/docs/early_gl_steamboats.html" },

    // Self-Unloading Ships (1902-1950)
    { id: 261, year: 1902, vessel: "SS Hennepin", from: "Duluth", to: "Chicago", type: "self-unloader", cargo: "stone (2,000 tons)", captain: "Lake Shore Stone Co.", tonnage: 2100, distance: 650, duration: "3.5 days", source: "https://en.wikipedia.org/wiki/SS_Hennepin" },
    { id: 262, year: 1908, vessel: "SS Wyandotte", from: "Cleveland", to: "Detroit", type: "self-unloader", cargo: "coal (3,000 tons)", captain: "First purpose-built self-unloader", tonnage: 3200, distance: 95, duration: "12 hours", source: "https://nmgl.org/wyandotte-at-the-co-coal-dock/" },
    { id: 263, year: 1925, vessel: "Self-unloader (conveyor belt)", from: "Buffalo", to: "Milwaukee", type: "self-unloader", cargo: "grain (4,500 tons)", captain: "Modern self-unloader", tonnage: 4800, distance: 650, duration: "3 days", source: "https://greatlakesships.wordpress.com/self-unloaders/" },
    { id: 264, year: 1950, vessel: "Self-unloader (500 tons/hr)", from: "Two Harbors", to: "Cleveland", type: "self-unloader", cargo: "iron ore (8,000 tons)", captain: "High-speed unloader", tonnage: 8500, distance: 880, duration: "3.5 days", source: "https://www.amazon.com/Buckets-Belts-Evolution-Great-Self-Unloaders/dp/0980175003" },
    { id: 265, year: 1935, vessel: "Bucket elevator unloader", from: "Duluth", to: "Buffalo", type: "self-unloader", cargo: "limestone (5,500 tons)", captain: "Automated unloading system", tonnage: 5800, distance: 950, duration: "4 days", source: "https://cslships.com/fleet/self-unloaders/" },

    // Dredges & Harbor Maintenance (1890-1940)
    { id: 266, year: 1892, vessel: "GLD&D Dredge (Columbian Expo)", from: "Chicago harbor", to: "Navy Pier site", type: "dredge", cargo: "harbor excavation", captain: "Great Lakes Dredge & Dock", tonnage: 580, distance: 3, duration: "seasonal", source: "https://gldd.com/gldd-history/" },
    { id: 267, year: 1905, vessel: "Hydraulic Dredge", from: "Chicago River", to: "river straightening project", type: "dredge", cargo: "sediment removal", captain: "GLD&D Company", tonnage: 720, distance: 5, duration: "continuous", source: "https://www.encyclopedia.com/books/politics-and-business-magazines/great-lakes-dredge-dock-company" },
    { id: 268, year: 1920, vessel: "Mechanical Dredge", from: "Duluth harbor", to: "harbor deepening", type: "dredge", cargo: "harbor maintenance", captain: "GLD&D fleet", tonnage: 890, distance: 2, duration: "seasonal", source: "https://gldd.com/gldd-history/" },
    { id: 269, year: 1930, vessel: "Hopper Dredge", from: "Cleveland harbor", to: "channel maintenance", type: "dredge", cargo: "sediment", captain: "Dredge contractor", tonnage: 950, distance: 4, duration: "continuous", source: "https://www.seagrant.wisc.edu/our-work/focus-areas/coastal-processes-and-engineering/coastal-processes/partial-list-of-great-lakes-dredging-contractors/" },
    { id: 270, year: 1940, vessel: "Support Tugboat (dredge fleet)", from: "Detroit harbor", to: "dredge operations", type: "support vessel", cargo: "dredge support", captain: "GLD&D tug fleet", tonnage: 285, distance: 5, duration: "variable", source: "https://gldd.com/gldd-history/" },

    // Propeller Steamers - Screw Propulsion (1841-1860)
    { id: 271, year: 1841, vessel: "Vandalia", from: "Oswego", to: "Chicago", type: "propeller steamer", cargo: "general freight", captain: "First screw propeller on Great Lakes", tonnage: 138, distance: 720, duration: "6 days", source: "https://oswegohistorical.org/education/the-vandalia-the-first-screw-propelled-vessel-on-the-great-lakes/" },
    { id: 272, year: 1845, vessel: "Propeller (twin screw)", from: "Buffalo", to: "Detroit", type: "propeller steamer", cargo: "bulk cargo", captain: "Early screw propulsion", tonnage: 225, distance: 260, duration: "36 hours", source: "https://navalmarinearchive.com/research/docs/early_gl_steamboats.html" },
    { id: 273, year: 1850, vessel: "Propeller steamer", from: "Cleveland", to: "Milwaukee", type: "propeller steamer", cargo: "passengers & freight", captain: "Efficient bulk transport", tonnage: 380, distance: 425, duration: "2.5 days", source: "https://www.maritimehistoryofthegreatlakes.ca/documents/HGL/default.asp?ID=s035" },
    { id: 274, year: 1855, vessel: "Propeller freighter", from: "Chicago", to: "Buffalo", type: "propeller steamer", cargo: "grain (900 tons)", captain: "Replacing sidewheelers", tonnage: 950, distance: 650, duration: "3.5 days", source: "https://navalmarinearchive.com/research/docs/early_gl_steamboats.html" },
    { id: 275, year: 1860, vessel: "Propeller passenger ship", from: "Detroit", to: "Chicago", type: "propeller steamer", cargo: "passengers (200 capacity)", captain: "Modern propeller design", tonnage: 580, distance: 280, duration: "24 hours", source: "https://en.wikipedia.org/wiki/Great_Lakes_passenger_steamers" },

    // Naval Vessels & Training Ships (1844-1945)
    { id: 276, year: 1844, vessel: "USS Michigan", from: "Detroit", to: "patrol stations", type: "naval patrol", cargo: "Great Lakes law enforcement", captain: "U.S. Navy Great Lakes Patrol", tonnage: 685, distance: 150, duration: "variable", source: "https://en.wikipedia.org/wiki/Great_Lakes_Patrol" },
    { id: 277, year: 1900, vessel: "USS Michigan (patrol)", from: "Erie", to: "Cleveland", type: "naval patrol", cargo: "border patrol duties", captain: "U.S. Navy", tonnage: 685, distance: 90, duration: "10 hours", source: "https://ss.sites.mtu.edu/mhugl/naval/" },
    { id: 278, year: 1942, vessel: "USS Wolverine (IX-64)", from: "Chicago Navy Pier", to: "training area", type: "aircraft carrier", cargo: "carrier landing training", captain: "U.S. Navy training", tonnage: 7700, distance: 25, duration: "daily ops", source: "https://chicagonavymemorial.org/chicagos-role-in-navy-history/training-ships-aircraft-carriers-lake-michigan" },
    { id: 279, year: 1943, vessel: "USS Sable (IX-81)", from: "Chicago Navy Pier", to: "training area", type: "aircraft carrier", cargo: "aviator qualification", captain: "U.S. Navy Cornbelt Fleet", tonnage: 8100, distance: 25, duration: "daily ops", source: "https://militaryhistorynow.com/2016/08/29/fresh-water-flattops-the-u-s-navys-forgotten-great-lakes-aircraft-carriers/" },
    { id: 280, year: 1944, vessel: "Training ship operations", from: "Naval Station Great Lakes", to: "Lake Michigan", type: "naval training", cargo: "18,000 pilots qualified", captain: "U.S. Navy", tonnage: 7900, distance: 30, duration: "training cycles", source: "https://www.history.navy.mil/research/underwater-archaeology/sites-and-projects/aircraft-wrecksites/aircraft-wrecks-in-lake-michigan.html" },

    // Oil Tankers & Petroleum Carriers (1936-1985)
    { id: 281, year: 1936, vessel: "PAN AMOCO", from: "Chicago", to: "Cleveland", type: "oil tanker", cargo: "petroleum products", captain: "Amoco Oil Company", tonnage: 2850, distance: 350, duration: "2 days", source: "https://greatlakeships.org/3702205/data" },
    { id: 282, year: 1960, vessel: "Imperial Oil tanker", from: "Sarnia", to: "Toronto", type: "oil tanker", cargo: "crude oil", captain: "Imperial Oil Limited", tonnage: 4200, distance: 180, duration: "24 hours", source: "https://greatlakesships.wordpress.com/tankers-2/" },
    { id: 283, year: 1970, vessel: "IMPERIAL WHITBY", from: "Detroit", to: "Port Colborne", type: "oil tanker", cargo: "gasoline", captain: "Imperial Oil fleet", tonnage: 5100, distance: 220, duration: "28 hours", source: "https://www.maritimehistoryofthegreatlakes.ca//documents/scanner/14/08/default.asp?ID=s004" },
    { id: 284, year: 1982, vessel: "Amoco Great Lakes", from: "Chicago", to: "Milwaukee", type: "oil tanker", cargo: "petroleum (tug-barge)", captain: "Amoco Oil Company", tonnage: 6800, distance: 85, duration: "10 hours", source: "https://greatlakesships.wordpress.com/amoco-great-lakes/" },
    { id: 285, year: 1975, vessel: "Petroleum tanker", from: "Toledo", to: "Detroit", type: "oil tanker", cargo: "refined petroleum", captain: "Great Lakes tanker fleet", tonnage: 5500, distance: 55, duration: "8 hours", source: "https://canadians.org/analysis/oil-shipments-great-lakes-now-and-come/" },

    // Grain Carriers & Floating Elevators (1843-1900)
    { id: 286, year: 1843, vessel: "Dart Elevator (steam)", from: "Buffalo grain elevator", to: "vessel loading", type: "grain elevator", cargo: "grain handling (first steam)", captain: "Joseph Dart innovation", tonnage: 0, distance: 0, duration: "continuous", source: "https://buffaloah.com/h/elev/hist/2/" },
    { id: 287, year: 1866, vessel: "Nimbs Floating Elevator", from: "Buffalo harbor", to: "vessel operations", type: "floating elevator", cargo: "grain transfer (5,000 bu)", captain: "Arunah B. Nimbs", tonnage: 450, distance: 1, duration: "continuous", source: "https://images.maritimehistoryofthegreatlakes.ca/63436/data" },
    { id: 288, year: 1870, vessel: "Lewis Floating Elevator", from: "Buffalo", to: "grain transfer ops", type: "floating elevator", cargo: "1,000 bushels/hour", captain: "W. Lewis operator", tonnage: 520, distance: 1, duration: "continuous", source: "https://buffaloah.com/h/elev/hist/2/" },
    { id: 289, year: 1860, vessel: "Grain carrier", from: "Chicago", to: "Buffalo", type: "grain carrier", cargo: "wheat (50,000 bushels)", captain: "Northwest grain fleet", tonnage: 1200, distance: 650, duration: "4 days", source: "https://www.maritimehistoryofthegreatlakes.ca/GreatLakes/Documents/HGL/default.asp?ID=c028" },
    { id: 290, year: 1897, vessel: "Grain freighter", from: "Duluth", to: "Buffalo", type: "grain carrier", cargo: "cereals (20% of lake trade)", captain: "Grain transport era", tonnage: 2800, distance: 950, duration: "5 days", source: "https://research.lib.buffalo.edu/greatlakes/economy" },

    // Christmas Tree Ships (1890-1920)
    { id: 291, year: 1868, vessel: "Rouse Simmons", from: "Milwaukee", to: "Chicago", type: "schooner", cargo: "general freight", captain: "Early career", tonnage: 205, distance: 85, duration: "12 hours", source: "https://en.wikipedia.org/wiki/Rouse_Simmons" },
    { id: 292, year: 1910, vessel: "Rouse Simmons (Christmas tree ship)", from: "Thompson Harbor", to: "Chicago", type: "schooner", cargo: "Christmas trees (3,000-5,000)", captain: "Captain Herman Schuenemann", tonnage: 205, distance: 290, duration: "3 days", source: "https://seahistory.org/sea-history-for-kids/christmas-tree-ship-rouse-simmons/" },
    { id: 293, year: 1912, vessel: "Rouse Simmons (final voyage)", from: "Northern Michigan", to: "Chicago", type: "schooner", cargo: "Christmas trees (lost at sea)", captain: "Captain Santa Schuenemann", tonnage: 205, distance: 290, duration: "lost in storm", source: "https://www.archives.gov/publications/prologue/2006/winter/christmas-tree.html" },
    { id: 294, year: 1900, vessel: "Christmas tree schooner", from: "Door County", to: "Milwaukee", type: "schooner", cargo: "Christmas trees", captain: "Seasonal tree trade", tonnage: 180, distance: 75, duration: "10 hours", source: "https://www.chicagomaritimemuseum.org/online-stories/the-christmas-tree-ships" },
    { id: 295, year: 1915, vessel: "Christmas tree trader", from: "Manistique", to: "Chicago", type: "schooner", cargo: "evergreen trees", captain: "One of dozen tree ships", tonnage: 195, distance: 180, duration: "24 hours", source: "https://marinesanctuary.org/blog/christmas-tree-ship/" },

    // Pulpwood & Paper Industry Carriers (1912-1960)
    { id: 296, year: 1914, vessel: "Ontario Transportation pulpwood carrier", from: "Quebec", to: "Thorold", type: "pulpwood carrier", cargo: "pulpwood (500,000 tons/year)", captain: "Ontario Transportation & Pulp Co.", tonnage: 1850, distance: 580, duration: "4 days", source: "https://www.maritimehistoryofthegreatlakes.ca/GreatLakes/Documents/Scanner/03/04/default.asp?ID=c007" },
    { id: 297, year: 1920, vessel: "Pulpwood carrier", from: "Eastern Quebec", to: "Ontario mills", type: "pulpwood carrier", cargo: "wood pulp", captain: "Canal transport", tonnage: 1650, distance: 520, duration: "3.5 days", source: "https://www.maritimehistoryofthegreatlakes.ca//Documents/gilmore/default.asp?ID=s013" },
    { id: 298, year: 1930, vessel: "Newsprint carrier", from: "Thorold mill", to: "Chicago", type: "paper carrier", cargo: "newsprint for Chicago Tribune", captain: "Ontario Paper Co.", tonnage: 2200, distance: 420, duration: "2.5 days", source: "https://www.greatlakesnow.org/lost-ships-and-newsworthy-trees/" },
    { id: 299, year: 1950, vessel: "Paper products carrier", from: "Thunder Bay", to: "Detroit", type: "paper carrier", cargo: "newsprint & paper products", captain: "Great Northern Paper fleet", tonnage: 2600, distance: 650, duration: "3 days", source: "https://en.wikipedia.org/wiki/Great_Lakes_Paper" },
    { id: 300, year: 1960, vessel: "Pulp freighter", from: "Sault Ste. Marie", to: "Cleveland", type: "pulpwood carrier", cargo: "wood pulp", captain: "Paper industry transport", tonnage: 2850, distance: 420, duration: "2 days", source: "https://en.wikipedia.org/wiki/Great_Northern_Paper_Company" },

    // Automobile & Vehicle Carriers (1896-1970)
    { id: 301, year: 1896, vessel: "Frank Rockefeller (ore carrier)", from: "Duluth", to: "Cleveland", type: "ore carrier", cargo: "iron ore", captain: "First 30 years as ore carrier", tonnage: 3900, distance: 880, duration: "5 days", source: "https://wi101.wisc.edu/great-lakes-shipping/" },
    { id: 302, year: 1926, vessel: "South Park (automobile carrier)", from: "Detroit", to: "Chicago", type: "automobile carrier", cargo: "automobiles", captain: "Erie Steamship Company", tonnage: 3900, distance: 280, duration: "24 hours", source: "https://wi101.wisc.edu/great-lakes-shipping/" },
    { id: 303, year: 1945, vessel: "SS Meteor (automobile carrier)", from: "Milwaukee", to: "Cleveland", type: "automobile carrier", cargo: "automobiles & vehicles", captain: "Post-war auto transport", tonnage: 4300, distance: 425, duration: "2.5 days", source: "https://www.eekwi.org/great-lakes/humans-and-great-lakes/great-lakes-ships" },
    { id: 304, year: 1960, vessel: "Vehicle carrier", from: "Detroit", to: "Duluth", type: "automobile carrier", cargo: "cars & machinery", captain: "Great Lakes auto fleet", tonnage: 4800, distance: 850, duration: "4 days", source: "https://en.wikipedia.org/wiki/Lake_freighter" },
    { id: 305, year: 1970, vessel: "SS Meteor (final service)", from: "Superior", to: "retirement", type: "multi-cargo", cargo: "oil & miscellaneous", captain: "75 years of service", tonnage: 4300, distance: 0, duration: "retired 1969", source: "https://wi101.wisc.edu/great-lakes-shipping/" },

    // Research Vessels & Survey Ships (1920-2022)
    { id: 306, year: 1920, vessel: "Survey vessel (early)", from: "Cleveland", to: "Lake Erie survey", type: "survey ship", cargo: "hydrographic mapping", captain: "U.S. Coast & Geodetic Survey", tonnage: 320, distance: 100, duration: "seasonal", source: "https://www.glerl.noaa.gov/" },
    { id: 307, year: 1970, vessel: "USGS research vessel", from: "Ann Arbor", to: "Lake Michigan", type: "research vessel", cargo: "fish & limnological sampling", captain: "Great Lakes Science Center", tonnage: 450, distance: 150, duration: "research cruise", source: "https://www.usgs.gov/centers/great-lakes-science-center/great-lakes-science-center-research-vessels" },
    { id: 308, year: 1985, vessel: "NOAA research vessel", from: "Muskegon", to: "Lake Michigan Field Station", type: "research vessel", cargo: "environmental monitoring", captain: "NOAA GLERL", tonnage: 520, distance: 80, duration: "research ops", source: "https://www.glerl.noaa.gov/lmfs/" },
    { id: 309, year: 2000, vessel: "Great Lakes science vessel", from: "Duluth", to: "Lake Superior survey", type: "research vessel", cargo: "multi-disciplinary platform", captain: "Great Lakes Science Fleet", tonnage: 580, distance: 200, duration: "seasonal", source: "https://canamglass.org/" },
    { id: 310, year: 2022, vessel: "NOAA Ship Thomas Jefferson", from: "Port of call", to: "Lake Huron survey", type: "survey ship", cargo: "hydrographic mapping (1,380 sq mi)", captain: "NOAA Office of Coast Survey", tonnage: 4000, distance: 250, duration: "field season", source: "https://nauticalcharts.noaa.gov/updates/noaa-focuses-on-the-great-lakes-for-the-2022-field-season/" },

    // Early Packet Boats & Mail Steamers (1826-1850)
    { id: 311, year: 1826, vessel: "First Lake Michigan steamer", from: "St. Joseph", to: "Chicago", type: "packet boat", cargo: "passengers & mail", captain: "Pioneering steamer", tonnage: 150, distance: 85, duration: "18 hours", source: "https://nmgl.org/lake-michigan-shipping-1830-1850-summer-1949/" },
    { id: 312, year: 1830, vessel: "Regular passenger service", from: "Buffalo", to: "Chicago", type: "packet boat", cargo: "passengers & mail (regular service)", captain: "Establishing regular routes", tonnage: 280, distance: 650, duration: "5 days", source: "https://nmgl.org/lake-michigan-shipping-1830-1850-summer-1949/" },
    { id: 313, year: 1837, vessel: "Illinois", from: "Detroit", to: "Milwaukee", type: "packet steamer", cargo: "passengers & freight", captain: "Largest & finest of era", tonnage: 420, distance: 340, duration: "2.5 days", source: "https://www.encyclopedia.com/history/dictionaries-thesauruses-pictures-and-press-releases/great-lakes-steamships" },
    { id: 314, year: 1838, vessel: "Great Western", from: "Cleveland", to: "Chicago", type: "packet steamer", cargo: "passengers & mail", captain: "Premium packet service", tonnage: 450, distance: 350, duration: "2.5 days", source: "https://www.encyclopedia.com/history/dictionaries-thesauruses-pictures-and-press-releases/great-lakes-steamships" },
    { id: 315, year: 1838, vessel: "Anthony Wayne", from: "Buffalo", to: "Milwaukee", type: "mail steamer", cargo: "eastern newspapers & mail", captain: "Captain Pratt", tonnage: 360, distance: 650, duration: "4 days", source: "https://nmgl.org/lake-michigan-shipping-1830-1850-summer-1949/" },

    // Bulk Carriers - Modern Coal & Ore Fleet (1900-2020)
    { id: 316, year: 1906, vessel: "Pittsburgh Steamship ore carrier", from: "Duluth", to: "Cleveland", type: "bulk carrier", cargo: "iron ore (7,500 tons)", captain: "Pittsburgh Steamship Co.", tonnage: 8200, distance: 880, duration: "4 days", source: "https://en.wikipedia.org/wiki/Great_Lakes_Fleet" },
    { id: 317, year: 1952, vessel: "Interlake coal carrier", from: "Toledo", to: "Detroit", type: "coal carrier", cargo: "coal for power generation", captain: "Interlake Steamship Co.", tonnage: 9500, distance: 55, duration: "8 hours", source: "https://www.interlake-steamship.com/our-fleet/" },
    { id: 318, year: 1976, vessel: "M/V Paul R. Tregurtha", from: "Two Harbors", to: "Detroit", type: "bulk carrier", cargo: "iron ore (68,000 tons)", captain: "Interlake Steamship", tonnage: 71500, distance: 850, duration: "3.5 days", source: "https://www.interlake-steamship.com/our-fleet/" },
    { id: 319, year: 1990, vessel: "Self-unloading bulk carrier", from: "Duluth", to: "Cleveland", type: "bulk carrier", cargo: "limestone & aggregates", captain: "Interlake fleet", tonnage: 58000, distance: 880, duration: "3.5 days", source: "https://lcaships.com/about/fleet/" },
    { id: 320, year: 2020, vessel: "Great Lakes Fleet bulk carrier", from: "Superior", to: "Gary", type: "bulk carrier", cargo: "coal (modern fleet)", captain: "Great Lakes Fleet Inc.", tonnage: 63000, distance: 650, duration: "3 days", source: "https://en.wikipedia.org/wiki/Great_Lakes_Fleet" },

    // Wooden Propeller Steamers (1869-1900)
    { id: 321, year: 1869, vessel: "R.J. Hackett (compound engine)", from: "Cleveland", to: "Marquette", type: "ore carrier", cargo: "iron ore (first specialized design)", captain: "Peck & Masters design", tonnage: 1200, distance: 480, duration: "2.5 days", source: "https://case.edu/ech/articles/l/lake-transportation" },
    { id: 322, year: 1875, vessel: "Wooden propeller steamer", from: "Chicago", to: "Buffalo", type: "bulk carrier", cargo: "grain (1,200 tons)", captain: "Steam propeller era", tonnage: 1350, distance: 650, duration: "3.5 days", source: "https://www.encyclopedia.com/history/dictionaries-thesauruses-pictures-and-press-releases/great-lakes-steamships" },
    { id: 323, year: 1880, vessel: "Lumber propeller", from: "Manistee", to: "Milwaukee", type: "lumber carrier", cargo: "lumber from Michigan", captain: "Lumber boom era", tonnage: 1100, distance: 95, duration: "14 hours", source: "https://maritimehistoryofthegreatlakes.ca/documents/hgl/default.asp?ID=s062" },
    { id: 324, year: 1887, vessel: "Triple-expansion steamer", from: "Duluth", to: "Buffalo", type: "ore carrier", cargo: "iron ore (first triple-expansion)", captain: "Advanced engine technology", tonnage: 2600, distance: 950, duration: "4.5 days", source: "https://www.encyclopedia.com/history/dictionaries-thesauruses-pictures-and-press-releases/great-lakes-steamships" },
    { id: 325, year: 1894, vessel: "Quadruple-expansion steamer", from: "Two Harbors", to: "Cleveland", type: "ore carrier", cargo: "iron ore (quad-expansion engine)", captain: "Cutting-edge technology", tonnage: 3200, distance: 880, duration: "4 days", source: "https://www.chicagomaritimemuseum.org/maritime-history/steamboats-and-steel-hulls" },

    // Racing Yachts & Recreational Sailing (1898-2025)
    { id: 326, year: 1898, vessel: "Chicago Mackinac Race (first)", from: "Chicago", to: "Mackinac Island", type: "yacht race", cargo: "oldest freshwater distance race", captain: "Chicago Yacht Club", tonnage: 0, distance: 333, duration: "variable", source: "https://en.wikipedia.org/wiki/Chicago_Yacht_Club_Race_to_Mackinac" },
    { id: 327, year: 1925, vessel: "Bayview Mackinac Race (first)", from: "Port Huron", to: "Mackinac Island", type: "yacht race", cargo: "racing sailboats", captain: "Bayview Yacht Club", tonnage: 0, distance: 300, duration: "variable", source: "https://bycmack.com/" },
    { id: 328, year: 1942, vessel: "Mac Race (wartime)", from: "Chicago", to: "Mackinac Island", type: "yacht race", cargo: "FDR message: 'Sail your race'", captain: "Bayview Yacht Club", tonnage: 0, distance: 300, duration: "variable", source: "https://www.mackinacblog.com/?p=88" },
    { id: 329, year: 1998, vessel: "Stars and Stripes (record)", from: "Chicago", to: "Mackinac Island", type: "multihull yacht", cargo: "record 18h 50m", captain: "Steve Fossett", tonnage: 0, distance: 333, duration: "18 hours 50 min", source: "https://www.mackinacisland.org/blog/post/destination-is-reward-in-epic-mackinac-island-yacht-races/" },
    { id: 330, year: 2025, vessel: "Bayview Mackinac Race", from: "Port Huron", to: "Mackinac Island", type: "yacht race", cargo: "101st anniversary race", captain: "250+ racing yachts", tonnage: 0, distance: 300, duration: "variable", source: "https://www.theinnatstonecliffe.com/blog/the-101st-bayview-mackinac-race-everything-you-need-to-know-before-the-start-on-july-12" },

    // Island Ferries & Passenger Services (1878-2024)
    { id: 331, year: 1878, vessel: "Arnold and Coats Ferry Line", from: "Mackinaw City", to: "Mackinac Island", type: "ferry", cargo: "passengers (first ferry line)", captain: "George T. Arnold & L.B. Coats", tonnage: 85, distance: 5, duration: "30 minutes", source: "https://www.hmdb.org/m.asp?m=140733" },
    { id: 332, year: 1887, vessel: "Ferry service (Grand Hotel era)", from: "St. Ignace", to: "Mackinac Island", type: "ferry", cargo: "summer visitors", captain: "Arnold Ferry", tonnage: 120, distance: 5, duration: "25 minutes", source: "https://www.arnoldtransitcompany.com/" },
    { id: 333, year: 1950, vessel: "Post-WWII water taxi", from: "Mackinaw City", to: "Mackinac Island", type: "ferry", cargo: "passengers (Shepler's start)", captain: "Water taxi service", tonnage: 95, distance: 5, duration: "20 minutes", source: "https://www.mackinacisland.net/ferries/" },
    { id: 334, year: 1979, vessel: "Star Line Ferry (first)", from: "St. Ignace", to: "Mackinac Island", type: "ferry", cargo: "passengers (third ferry line)", captain: "Star Line Mackinac Ferry", tonnage: 180, distance: 5, duration: "16 minutes", source: "https://www.mackinacisland.net/ferries/" },
    { id: 335, year: 2000, vessel: "MV Pelee Islander", from: "Sandusky", to: "Pelee Island", type: "ferry", cargo: "vehicles & passengers", captain: "Pelee Island Transportation", tonnage: 850, distance: 22, duration: "90 minutes", source: "https://www.ontarioferries.com/pelee-island-ferries/" },
    { id: 336, year: 2024, vessel: "High-speed aluminum ferry", from: "Mackinaw City", to: "Mackinac Island", type: "ferry", cargo: "passengers (20-30 mph)", captain: "Modern ferry service", tonnage: 145, distance: 5, duration: "15 minutes", source: "https://www.michigan.org/ferry-services" },

    // Grain Carriers - Cargill & Major Grain Shippers (1886-1939)
    { id: 337, year: 1886, vessel: "Spokane (first steel freighter)", from: "Chicago", to: "Buffalo", type: "grain carrier", cargo: "wheat (increased capacity)", captain: "Steel-hulled grain carrier", tonnage: 2900, distance: 650, duration: "3.5 days", source: "https://case.edu/ech/articles/l/lake-transportation" },
    { id: 338, year: 1893, vessel: "Buffalo grain carrier", from: "Lake Superior", to: "Buffalo", type: "grain carrier", cargo: "wheat (2/3 of eastward grain)", captain: "Buffalo grain fleet", tonnage: 3200, distance: 950, duration: "4.5 days", source: "https://research.lib.buffalo.edu/greatlakes/economy" },
    { id: 339, year: 1900, vessel: "Cargill grain freighter", from: "Duluth", to: "Buffalo", type: "grain carrier", cargo: "wheat for eastern markets", captain: "Cargill shipping operation", tonnage: 3500, distance: 950, duration: "4.5 days", source: "https://www.fundinguniverse.com/company-histories/cargill-inc-history/" },
    { id: 340, year: 1930, vessel: "Wheat carrier (primary cargo)", from: "Thunder Bay", to: "Cleveland", type: "grain carrier", cargo: "wheat (leading grain)", captain: "Great Lakes grain fleet", tonnage: 5200, distance: 650, duration: "3 days", source: "https://americanhistory.si.edu/node/14158" },
    { id: 341, year: 1939, vessel: "Cargill Superior Elevator operation", from: "Superior", to: "Buffalo", type: "grain carrier", cargo: "grain transfer via Superior Elevator", captain: "Cargill acquisition", tonnage: 6800, distance: 950, duration: "4 days", source: "https://abandonedonline.net/location/cargill-superior-elevator/" },

    // Stone, Gravel & Sand Barges (1890-2000)
    { id: 342, year: 1890, vessel: "Scow barge (towed)", from: "Chicago", to: "Milwaukee", type: "stone barge", cargo: "stone & gravel", captain: "Towed by steamer", tonnage: 420, distance: 85, duration: "12 hours", source: "https://nmgl.org/the-tow-barge-system-revisited/" },
    { id: 343, year: 1920, vessel: "Sand & gravel barge", from: "Duluth", to: "Superior", type: "aggregate barge", cargo: "construction sand", captain: "Bulk commodity transport", tonnage: 880, distance: 5, duration: "2 hours", source: "https://www.eekwi.org/great-lakes/humans-and-great-lakes/great-lakes-ships" },
    { id: 344, year: 1950, vessel: "Open barge (coal, stone)", from: "Cleveland", to: "Detroit", type: "bulk barge", cargo: "bauxite ore & stone", captain: "Great Lakes barge fleet", tonnage: 1950, distance: 95, duration: "12 hours", source: "https://en.wikipedia.org/wiki/Lake_freighter" },
    { id: 345, year: 1990, vessel: "Articulated Tug-Barge (ATB)", from: "Buffalo", to: "Chicago", type: "tug-barge", cargo: "aggregates & cement", captain: "Hinged connection system", tonnage: 8500, distance: 650, duration: "3.5 days", source: "https://maritime-executive.com/editorials/the-potential-for-a-mega-sized-tug-barge-on-the-upper-great-lakes" },
    { id: 346, year: 2000, vessel: "Converted self-unloader barge", from: "Two Harbors", to: "Gary", type: "tug-barge", cargo: "taconite pellets", captain: "Former self-unloader", tonnage: 12000, distance: 480, duration: "2.5 days", source: "https://www.great-lakes-north-america.com/maritime/bulk-carriers/" },

    // Rum Runners & Prohibition Era (1920-1933)
    { id: 347, year: 1920, vessel: "Windsor rum runner", from: "Windsor", to: "Detroit", type: "smuggler", cargo: "whisky (75% of U.S. supply)", captain: "Rum Alley bootlegger", tonnage: 25, distance: 1, duration: "30 minutes", source: "https://greatlakes.guide/ideas/how-an-ontario-island-kept-the-us-boozy-during-the-prohi" },
    { id: 348, year: 1922, vessel: "Main Duck Island runner", from: "Main Duck Island", to: "Michigan", type: "smuggler", cargo: "alcohol (legal export)", captain: "Ontario rum runner", tonnage: 35, distance: 85, duration: "variable", source: "https://greatlakes.guide/ideas/how-an-ontario-island-kept-the-us-boozy-during-the-prohi" },
    { id: 349, year: 1925, vessel: "Sault Ste. Marie bootlegger", from: "Sault Ste. Marie ON", to: "Sault Ste. Marie MI", type: "smuggler", cargo: "cases of illegal alcohol", captain: "Cross-border smuggler", tonnage: 18, distance: 1, duration: "20 minutes", source: "https://www.cnrs-scrn.org/northern_mariner/vol11/nm_11_3_33to40.pdf" },
    { id: 350, year: 1928, vessel: "Tomoka (armed runner)", from: "Ontario", to: "Michigan", type: "smuggler", cargo: "alcohol (outfitted to defend)", captain: "Armed rum runner", tonnage: 42, distance: 120, duration: "variable", source: "https://prohibition.themobmuseum.org/the-history/the-rise-of-organized-crime/rum-running/" },
    { id: 351, year: 1930, vessel: "Lake Superior rum runner", from: "Thunder Bay", to: "Duluth", type: "smuggler", cargo: "illegal alcohol", captain: "Lake Superior bootlegger", tonnage: 28, distance: 150, duration: "variable", source: "https://commons.nmu.edu/cgi/viewcontent.cgi?article=1020&context=upper_country" },

    // Submarines - WWII Training & Construction (1941-1960)
    { id: 352, year: 1941, vessel: "USS Peto (SS-265) construction", from: "Manitowoc shipyard", to: "Lake Michigan trials", type: "submarine", cargo: "First freshwater-built submarine", captain: "Manitowoc Shipbuilding Co.", tonnage: 1526, distance: 15, duration: "sea trials", source: "https://ss.sites.mtu.edu/mhugl/2015/10/11/ss-265-uss-peto-1st-freshwater-built-submarine/" },
    { id: 353, year: 1942, vessel: "USS Peto (launched)", from: "Manitowoc", to: "New Orleans", type: "submarine", cargo: "228 days ahead of schedule", captain: "U.S. Navy", tonnage: 1526, distance: 1500, duration: "river transit", source: "https://www.hmdb.org/m.asp?m=98384" },
    { id: 354, year: 1943, vessel: "Manitowoc submarine (WWII)", from: "Manitowoc", to: "Lake Michigan trials", type: "submarine", cargo: "1 of 28 submarines built", captain: "Manitowoc Shipbuilding", tonnage: 1550, distance: 20, duration: "trials", source: "https://northernwilds.com/submarines-in-lake-superior-or-the-great-lakes/" },
    { id: 355, year: 1945, vessel: "WWII submarine production", from: "Manitowoc shipyard", to: "Pacific theater", type: "submarine", cargo: "25 saw combat action", captain: "U.S. Navy submarines", tonnage: 1560, distance: 0, duration: "wartime service", source: "https://www.usni.org/magazines/naval-history-magazine/2008/october/those-stout-manitowoc-boats" },
    { id: 356, year: 1956, vessel: "USS Peto (training submarine)", from: "Great Lakes Naval Station", to: "training operations", type: "submarine", cargo: "naval reserve training", captain: "U.S. Navy training", tonnage: 1526, distance: 50, duration: "training ops", source: "https://ss.sites.mtu.edu/mhugl/2015/10/11/ss-265-uss-peto-1st-freshwater-built-submarine/" },

    // Fireboats - Marine Fire Protection (1877-2024)
    { id: 357, year: 1877, vessel: "Geyser (first fireboat)", from: "Chicago harbor", to: "Chicago River", type: "fireboat", cargo: "firefighting (post-1871 fire)", captain: "Chicago Fire Department", tonnage: 220, distance: 3, duration: "emergency response", source: "https://chicagology.com/harbor/fireboats/" },
    { id: 358, year: 1908, vessel: "Chicago fireboat fleet", from: "Lake Michigan", to: "Chicago waterfront", type: "fireboat", cargo: "9 fireboats operating", captain: "City of Chicago", tonnage: 285, distance: 5, duration: "fire protection", source: "https://chicagology.com/harbor/fireboats/" },
    { id: 359, year: 1937, vessel: "Fred A. Busse", from: "Bay City MI", to: "Chicago", type: "fireboat", cargo: "10,000 gal/min capacity", captain: "Chicago Fire Department", tonnage: 425, distance: 280, duration: "44 years service", source: "https://fireboattours.com/chicago-fireboat-history/" },
    { id: 360, year: 1960, vessel: "Fred A. Busse (active duty)", from: "Chicago River", to: "Lake Michigan", type: "fireboat", cargo: "water spray 27 stories high", captain: "CFD largest diesel fireboat", tonnage: 425, distance: 5, duration: "fire operations", source: "https://en.wikipedia.org/wiki/Fireboats_of_Chicago" },
    { id: 361, year: 2024, vessel: "Fred A. Busse (tour vessel)", from: "Chicago River", to: "Lake Michigan", type: "tour boat", cargo: "historical & architectural tours", captain: "Chicago Fireboat Tours", tonnage: 425, distance: 10, duration: "tour operations", source: "https://fireboattours.com/" },

    // Cruise Ships & Passenger Liners (1903-2025)
    { id: 362, year: 1903, vessel: "Tionesta (Anchor Line)", from: "Buffalo", to: "Duluth", type: "passenger liner", cargo: "passengers & cargo", captain: "Pennsylvania Railroad", tonnage: 3200, distance: 950, duration: "5 days", source: "https://en.wikipedia.org/wiki/Great_Lakes_passenger_steamers" },
    { id: 363, year: 1904, vessel: "Juniata (Anchor Line)", from: "Cleveland", to: "Buffalo", type: "passenger liner", cargo: "passengers & cargo", captain: "Anchor Line", tonnage: 3250, distance: 180, duration: "overnight", source: "https://greatlakes.bgsu.edu/item/437136" },
    { id: 364, year: 1910, vessel: "SS Octorara (launched)", from: "Cleveland shipyard", to: "Buffalo", type: "passenger liner", cargo: "passengers & cargo", captain: "Anchor Line triplet", tonnage: 3300, distance: 180, duration: "overnight", source: "https://www.greatlakesvesselhistory.com/histories-by-name/o/octorara" },
    { id: 365, year: 1933, vessel: "SS Octorara (cruise voyage)", from: "Buffalo", to: "Great Lakes ports", type: "cruise ship", cargo: "passengers (detailed travel diary)", captain: "Great Lakes Transit Corp.", tonnage: 3300, distance: 800, duration: "multi-day cruise", source: "https://www.mbenjaminkatzfinebooksraremanuscripts.com/product/4964/1933-Detailed-Travel-Diary-of-a-Young-Woman-Cruising-the-Great-Lakes-on-the-SS-Octorara-Making-Many-Stops-Along-the-Way-Unknown" },
    { id: 366, year: 1913, vessel: "Georgian Bay Line (founded)", from: "Chicago", to: "Georgian Bay", type: "passenger service", cargo: "transit & cruise service", captain: "Chicago Duluth Georgian Bay Transit", tonnage: 3500, distance: 420, duration: "multi-day", source: "https://en.wikipedia.org/wiki/Georgian_Bay_Line" },
    { id: 367, year: 1950, vessel: "Georgian Bay Line (cruise focus)", from: "Duluth", to: "Georgian Bay", type: "cruise ship", cargo: "cruise trade (post-war shift)", captain: "Georgian Bay Line", tonnage: 3800, distance: 650, duration: "cruise voyage", source: "https://en.wikipedia.org/wiki/Georgian_Bay_Line" },
    { id: 368, year: 2025, vessel: "Pearl Seas Cruises", from: "Toronto", to: "Duluth", type: "cruise ship", cargo: "Great Lakes & Georgian Bay", captain: "Modern cruise operations", tonnage: 5050, distance: 850, duration: "7-11 nights", source: "https://www.pearlseascruises.com/cruises/great-lakes-cruises/7-night-great-lakes-and-georgian-bay" },

    // Icebreakers - Winter Navigation (1979-2025)
    { id: 369, year: 1979, vessel: "USCG icebreaking fleet", from: "Detroit", to: "Lake Superior", type: "icebreaker", cargo: "winter navigation (20 vessels)", captain: "U.S. & Canadian Coast Guard", tonnage: 1800, distance: 650, duration: "seasonal", source: "https://lcaships.com/http-www-lcaships-com-wp-content-uploads-2020-06-icebreaking-resources-10-june-2020-final-pdf/" },
    { id: 370, year: 1990, vessel: "140-foot icebreaking tug", from: "Sault Ste. Marie", to: "Duluth", type: "icebreaker", cargo: "commercial shipping support", captain: "USCG", tonnage: 662, distance: 420, duration: "ice operations", source: "https://www.gao.gov/products/gao-24-106619" },
    { id: 371, year: 2000, vessel: "Canadian CCG icebreaker", from: "Montreal", to: "Great Lakes", type: "icebreaker", cargo: "winter icebreaking (Dec-May)", captain: "Canadian Coast Guard", tonnage: 2200, distance: 580, duration: "seasonal ops", source: "https://www.ccg-gcc.gc.ca/icebreaking-deglacage/fleet-flotte-eng.html" },
    { id: 372, year: 2006, vessel: "USCGC Mackinaw (WLBB-30)", from: "Cheboygan", to: "St. Mary's River", type: "heavy icebreaker", cargo: "32-inch ice capability", captain: "U.S. Coast Guard", tonnage: 3500, distance: 150, duration: "icebreaking ops", source: "https://en.wikipedia.org/wiki/USCGC_Mackinaw_(WLBB-30)" },
    { id: 373, year: 2025, vessel: "USCG Great Lakes fleet", from: "Various ports", to: "ice operations", type: "icebreaker", cargo: "9 icebreakers (6 tugs, 2 tenders, 1 heavy)", captain: "U.S. Coast Guard", tonnage: 1850, distance: 200, duration: "winter season", source: "https://www.greatlakesports.org/policy-positions/improve-great-lakes-icebreaking/" },

    // Pilot Boats - Harbor Pilotage Service (1960-2024)
    { id: 374, year: 1960, vessel: "Lakes Pilots boat", from: "Detroit River", to: "Lake Erie ports", type: "pilot boat", cargo: "harbor pilots (compulsory pilotage)", captain: "Lakes Pilots Association", tonnage: 45, distance: 25, duration: "pilot transfer", source: "https://www.lakespilots.com/" },
    { id: 375, year: 1980, vessel: "Western Great Lakes pilot launch", from: "Port Huron", to: "Lake Michigan", type: "pilot boat", cargo: "pilotage for 60 ports", captain: "Western Great Lakes Pilots", tonnage: 55, distance: 180, duration: "pilot ops", source: "https://www.wglpa.com/" },
    { id: 376, year: 2000, vessel: "Pilot boat (high-powered)", from: "Cleveland", to: "incoming vessels", type: "pilot boat", cargo: "pilot transfer (orange/red/yellow)", captain: "Great Lakes pilotage", tonnage: 38, distance: 15, duration: "quick response", source: "https://en.wikipedia.org/wiki/Pilot_boat" },
    { id: 377, year: 2020, vessel: "Waiska Pilot", from: "Sault Ste. Marie", to: "Lake Superior", type: "pilot boat", cargo: "51 registered pilots", captain: "Western Great Lakes Pilots", tonnage: 62, distance: 50, duration: "pilot transfer", source: "https://professionalmariner.com/article/western-great-lakes-pilots-association-debuts-new-pilot-boats/" },
    { id: 378, year: 2024, vessel: "St. Mary's Pilot", from: "St. Mary's River", to: "harbor operations", type: "pilot boat", cargo: "modern pilot launch", captain: "Western Great Lakes Pilots", tonnage: 65, distance: 20, duration: "pilot service", source: "https://professionalmariner.com/article/western-great-lakes-pilots-association-debuts-new-pilot-boats/" },

    // Dry Docks & Shipyard Vessels (1891-2024)
    { id: 379, year: 1891, vessel: "Superior dry dock construction", from: "Superior shipyard", to: "dry dock operations", type: "dry dock", cargo: "628-ft largest on Great Lakes", captain: "Fraser Shipyards", tonnage: 0, distance: 0, duration: "ship repair", source: "https://www.startribune.com/fraser-shipyards-in-superior-eyes-30-million-dry-dock-upgrade/571373312" },
    { id: 380, year: 1892, vessel: "Kingston Dry Dock", from: "Kingston ON", to: "ship repair", type: "dry dock", cargo: "national historic site", captain: "Ontario shipyard", tonnage: 0, distance: 0, duration: "70 years service", source: "https://greatlakesmuseum.ca/experience/exhibits-and-galleries/kingston-dry-dock-and-pump-house/" },
    { id: 381, year: 1920, vessel: "Rieboldt & Wolter dry dock", from: "Sturgeon Bay", to: "wooden vessel repair", type: "dry dock", cargo: "most reputable on Great Lakes", captain: "Sturgeon Bay shipyard", tonnage: 0, distance: 0, duration: "ship construction", source: "https://wi101.wisc.edu/sturgeon-bay-shipbuilding-and-drydock-company/" },
    { id: 382, year: 1970, vessel: "Floating drydock (250-ton)", from: "Cleveland", to: "ship maintenance", type: "floating dry dock", cargo: "vessel repairs", captain: "Great Lakes Towing Co.", tonnage: 0, distance: 2, duration: "repair operations", source: "https://thegreatlakesgroup.com/great-lakes-shipyard" },
    { id: 383, year: 2024, vessel: "US Navy-certified floating drydock", from: "Fincantieri Bay Shipbuilding", to: "ship repair", type: "floating dry dock", cargo: "modern repair facility", captain: "Fincantieri", tonnage: 0, distance: 0, duration: "continuous", source: "https://wi101.wisc.edu/sturgeon-bay-shipbuilding-and-drydock-company/" },

    // Tall Ships & Historic Replicas (1812-2024)
    { id: 384, year: 1812, vessel: "U.S. Brig Niagara (replica)", from: "Erie PA", to: "Great Lakes ports", type: "tall ship", cargo: "War of 1812 battleship replica (198-ft)", captain: "Historic replica", tonnage: 280, distance: 120, duration: "festival tours", source: "https://midwestweekends.com/plan-a-trip/history-heritage/frontier-history/tall-ships-festivals/" },
    { id: 385, year: 1840, vessel: "Madeline (replica schooner)", from: "Traverse City", to: "Great Lakes", type: "tall ship", cargo: "92-ft commercial schooner replica", captain: "Maritime history education", tonnage: 78, distance: 150, duration: "educational cruises", source: "https://www.traversecity.com/things-to-do/attractions/tall-ships/" },
    { id: 386, year: 1810, vessel: "Friends Good Will (replica)", from: "South Haven", to: "Great Lakes ports", type: "tall ship", cargo: "topsail merchant sloop replica", captain: "Michigan Maritime Museum", tonnage: 52, distance: 85, duration: "educational voyages", source: "https://michiganmaritimemuseum.org/explore/our-fleet/friends-good-will/" },
    { id: 387, year: 1980, vessel: "Pathfinder (brigantine)", from: "Toronto", to: "Great Lakes", type: "brigantine", cargo: "60-ft sail training (youth)", captain: "Toronto Brigantine Inc.", tonnage: 68, distance: 100, duration: "training voyages", source: "https://sailtraininginternational.org/vessel/pathfinder/" },
    { id: 388, year: 1985, vessel: "Playfair (brigantine)", from: "Toronto", to: "Lake Ontario", type: "brigantine", cargo: "60-ft twin of Pathfinder", captain: "Toronto Brigantine Inc.", tonnage: 68, distance: 95, duration: "youth training", source: "https://sailtraininginternational.org/vessel/pathfinder/" },
    { id: 389, year: 2000, vessel: "Pride of Baltimore II (replica)", from: "Baltimore", to: "Great Lakes festivals", type: "tall ship", cargo: "157-ft privateer replica", captain: "Tall Ships festivals", tonnage: 195, distance: 650, duration: "festival circuit", source: "http://www.sailingbreezes.com/sailing_breezes_current/articles/aug01/tallships.htm" },
    { id: 390, year: 2024, vessel: "Tall Ships Challenge", from: "Various ports", to: "Great Lakes circuit", type: "tall ship", cargo: "floating history festivals", captain: "Great Lakes Tall Ships", tonnage: 0, distance: 850, duration: "summer season", source: "https://www.ourmidland.com/lifestyles/article/Tall-Ships-A-celebration-of-floating-history-6959194.php" }
];
